"""
Django settings for DPTC project.
...
SECRET_KEY = 'django-insecure-)95f#pqua$!_8pw@i)wc=#hh(ee&&(eg6rz#@2mds#nhj$w17a'
...
WSGI_APPLICATION = 'DPTC.wsgi.application'
